...
class ElegooPrinterSensor(ElegooPrinterEntity, SensorEntity):
    ...
    def extra_state_attributes(self) -> dict:
        ...
        """
        return self.entity_description.extra_attributes(self)  # type: ignore[attr-defined, no-any-return]
    ...
    def available(self) -> bool:
        ...
        if not super().available:
            return False
        return self.entity_description.available_fn(self.printer_data)  # type: ignore[attr-defined, no-any-return]
